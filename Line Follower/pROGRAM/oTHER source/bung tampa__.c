...
{
if (gita==1) {goto cp1;}
else if (gita==2) {goto cp2;}
else if (gita==3) {goto cp3;}
else if (gita==4) {goto cp_motong;}
...
switch (select)
        {
        case 1: lcd_gotoxy(0,1);
                lcd_putsf("  >cekpoint1< ");break;
        case 2: lcd_gotoxy(0,1);
                lcd_putsf("  >cekpoint2< ");break;
        case 3: lcd_gotoxy(0,1);
                lcd_putsf("cek_pointfinal");break;
        case 4: lcd_gotoxy(0,1);
                lcd_putsf("  >kepepet<   ");break;
        ...
        case 8: lcd_gotoxy(0,1);
                lcd_putsf("   >potong<   ");break;
        default:break;
        }
delay_ms(150);
...
switch (select)
        {
        case 1:gita=1;action();break;
        case 2:gita=2;action();break;
        case 3:gita=3;action();break;
        case 4:other_way();break;
        case 5:pid_murni();break;
        case 6:set_speed();break;
        case 7:display_cal();break;
        case 8:gita=4;action();break;
        }
        goto main;
 }
 else {delay_ms(85);}
...
backlight=1;
lcd_gotoxy(0,0);
lcd_putsf("Ishihara Satomi");
lcd_gotoxy(0,1);
lcd_putsf("TE UGM 06 07");
delay_ms(1000);
backlight=0;
frontlight=0;
...
while (1)
      {
      if(enter==0) {gita=1;action();}
      else if(cancel==0) {main_menu();}
      else if(add==0) {gita=4;action();}
      else if(sub==0) {gita=2;action();}
      };
}
