...
__DELAY_USW_LOOP:
	...
	.INCLUDE "slave_tx.vec"
	.INCLUDE "slave_tx.inc"
...
;       9 Version :
;      10 Date    : 10/16/2011
;      11 Author  : Handiko Gesang Anugrah Sejati
;      12 Company : Teknik Fisika UGM --- LPKTA UGM
;      13 Comments:
;      14 
;      15 
...
;      25 #include <delay.h>
;      26 
;      27 #define data_input PIND.0
;      28 #define TX_CONTROL PIND.1
;      29 #define PWM_OUT PORTD.2
;      30 #define ON 1
;      31 #define OFF 0
;      32 
;      33 void main(void)
