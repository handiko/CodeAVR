...
unsigned char eeprom bt7=7,bt6=7,bt5=7,bt4=7,bt3=7,bt2=7,bt1=7,bt0=9;
...
int PV, error, last_error, d_error, i_speed=0;
...
{
        xcount++;
        if(xcount<=lpwm)PORTD.4=1; // PORTC.1 = 1;
        else PORTD.4=0;  // PORTC.1 = 0;
        if(xcount<=rpwm)PORTD.5=1;
        else PORTD.5=0;
        TCNT0=0xFF;
}
void maju(){PORTD.1=1;PORTD.0=0;PORTD.6=1;PORTD.3=0;}
void mundur(){PORTD.1=0;PORTD.0=1;PORTD.6=0;PORTD.3=1;}
void bkan(){PORTD.1=0;PORTD.0=0;PORTD.6=1;PORTD.3=0;}
void bkir(){PORTD.1=1;PORTD.0=0;PORTD.6=0;PORTD.3=0;}
void rotkan(){PORTD.1=0;PORTD.0=1;PORTD.6=1;PORTD.3=0;}
void rotkir(){PORTD.1=1;PORTD.0=0;PORTD.6=0;PORTD.3=1;}
void stop(){ PORTD.1=0;PORTD.0=0;PORTD.6=0;PORTD.3=0; }
...
    if(sensor==0b00000001){bkan();      error = 15;     x=1;}  //kanan
    if(sensor==0b00000011){bkan();      error = 10;     x=1;}
    if(sensor==0b00000010){maju();      error = 8;      x=1;}
    if(sensor==0b00000110){maju();      error = 5;      x=1;}
    if(sensor==0b00000100){maju();      error = 3;      x=1;}
    if(sensor==0b00001100){maju();      error = 2;      x=1;}
    if(sensor==0b00001000){maju();      error = 1;      x=1;}
    //if(sensor==0b00011000){maju();rpwm=75;lpwm=75;}  //tengah
    if(sensor==0b00010000){maju();      error = -1;     x=0;}
    if(sensor==0b00110000){maju();      error = -2;     x=0;}
    if(sensor==0b00100000){maju();      error = -3;     x=0;}
    if(sensor==0b01100000){maju();      error = -5;     x=0;}
    if(sensor==0b01000000){maju();      error = -8;     x=0;}
    if(sensor==0b11000000){bkir();      error = -10;    x=0;}
    if(sensor==0b10000000){bkir();      error = -15;    x=0;}  //kiri
