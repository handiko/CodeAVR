...
interrupt [TIM1_OVF] void timer1_ovf_isr(void)
{
    ...
    {
        sensor_1[timer1_count] = (255 - read_adc(0));
        sensor_2[timer1_count] = (255 - read_adc(1));
...
void kirim_data(void)
{
    ...
    putchar(',');
    putchar((unsigned char)(sensor_1_min));
    putchar((unsigned char)(sensor_1_ave));
    putchar((unsigned char)(sensor_1_max));

    putchar((unsigned char)(sensor_2_min));
    putchar((unsigned char)(sensor_2_ave));
    putchar((unsigned char)(sensor_2_max));

    putchar((unsigned char)(sensor_3_min));
    putchar((unsigned char)(sensor_3_ave));
    putchar((unsigned char)(sensor_3_max));

    putchar((unsigned char)(sensor_4_min));
    putchar((unsigned char)(sensor_4_ave));
    putchar((unsigned char)(sensor_4_max));
