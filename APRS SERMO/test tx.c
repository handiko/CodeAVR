...
void kirim_paket(void)
{
        ...
        if(beacon_stat == 20)
        {
                ...
                for(i=0;i<42;i++)       kirim_karakter(def_t[i]);
        
        else if(beacon_stat == 22)
                for(i=0;i<61;i++)       kirim_karakter(eqn_t[i]);
        
        else if(beacon_stat == 23)
                for(i=0;i<36;i++)       kirim_karakter(unit_t[i]); 
                
        else if(beacon_stat == 25)
                beacon_stat = 0;
        else 
        {
...
{
        unsigned int bs1 = 0,bs2 = 0,bs3 = 0,bs4 = 0;
