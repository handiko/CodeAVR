...
unsigned char tadi_white_line, rear_sensor10, rear_sensor11, rear_sensor30, rear_sensor31,front_sensor10,front_sensor11,front_sensor30,front_sensor31;
...
switch(front_sensor)
    ...
    case 0b11111111:error= 17;backlight_on=10;white_line=1;break;
    }
}
...
switch(front_sensor)
    {
    case 0b11111000:error=  -10;break;white_line=1;break;
    case 0b11110001:error=   5;break;white_line=1;break;
    case 0b11100011:error=   1;break;white_line=1;kp=speed/20;kd=6*kp;break;
    case 0b11000111:error=  -1;break;white_line=1;kp=speed/20;kd=6*kp;break;
    case 0b10001111:error=  -5;break;white_line=1;break;
    case 0b00011111:error= 10;break;white_line=1;break;
    }
}
...
/*
front_sensor10=(front_sensor)&(0b10000000);
front_sensor30=(front_sensor)&(0b01000000);

front_sensor11=(front_sensor)&(0b00000001);
front_sensor31=(front_sensor)&(0b00000010);

if (front_sensor10!=0&&front_sensor30!=0){white_line=1;}//;tadi_white_line=15;}
if (front_sensor11!=0&&front_sensor31!=0){white_line=1;}//;tadi_white_line=15;}
*/
