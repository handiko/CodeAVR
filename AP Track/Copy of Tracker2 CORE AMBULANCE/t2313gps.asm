...
; 0000 0047 	{
; 0000 0048 		char data;
; 0000 0049 		while (rx_counter==0);
;	data -> R17
; 0000 004A 		data=rx_buffer[rx_rd_index];
; 0000 004B 		if (++rx_rd_index == RX_BUFFER_SIZE) rx_rd_index=0;
; 0000 004C 		#asm("cli")
; 0000 004D 		--rx_counter;
; 0000 004E 		#asm("sei")
...
; 0000 0057 	CLKPR=0x80;
	LDI  R30,LOW(128)
	OUT  0x26,R30
; 0000 0058 	CLKPR=0x00;
	LDI  R30,LOW(0)
	OUT  0x26,R30
...
; 0000 0067 	// Func6=In Func5=In Func4=In Func3=In Func2=In Func1=Out Func0=In
; 0000 0068 	// State6=T State5=T State4=T State3=T State2=T State1=0 State0=T
...
; 0000 006E {
_InitUSART:
; 0000 006F 	UCSRA = 0x00;
	LDI  R30,LOW(0)
	OUT  0xB,R30
; 0000 0070 	UCSRB = 0xD8;
	LDI  R30,LOW(216)
	OUT  0xA,R30
; 0000 0071 	UCSRC = 0x06;
	LDI  R30,LOW(6)
	OUT  0x3,R30
; 0000 0072         UBRRH = 0x00;
	LDI  R30,LOW(0)
	OUT  0x2,R30
; 0000 0073         UBRRL = 0x9B;
	LDI  R30,LOW(155)
	OUT  0x9,R30
; 0000 0074 }
	RET
...
; 0000 0077 {
; 0000 0078 	if(getchar()=='$')
; 0000 0079         {
; 0000 007A          	getchar();
; 0000 007B                 getchar();
; 0000 007C                 getchar();
; 0000 007D                 getchar();
; 0000 007E                 if(getchar()=='C')
; 0000 007F                 	return(1);
; 0000 0080         }
; 0000 0081 }
;
...
; 0000 0088 {
; 0000 0089  	int i;
; 0000 008A         for(i=0; i<80; i++)
;	i -> R16,R17
; 0000 008B         {
; 0000 008C         	gps_buff[i]=getchar();
; 0000 008D         }
; 0000 008E }
;
...
; 0000 0096 {
_main:
; 0000 0097 	InitClockDivision();
	RCALL _InitClockDivision
; 0000 0098         InitIOPorts();
	RCALL _InitIOPorts
; 0000 0099         InitUSART();
	RCALL _InitUSART
; 0000 009A         ACSR=0x80;
