...
{ 
    ...
    menu01: 
        ...
        goto menu01;        //looping menu01, jika tidak ada yang dipilih, maka LCD akan terus menampilkan menu01
...
#define Enki PORTD.4
#define kirplus PORTD.3
#define kirmin PORTD.6

#define Enka PORTD.5
#define kaplus PORTD.0
#define kamin PORTD.1    
...
void scanBlackLine() 
{
    ...
    PERHATIKAN TENTANG diffPWM..!!! APA ITU..?? 
    PERIKSA LAGI..!! 
    KALO GERAKAN ROBOT TIDAK SEIMBANG, HAPUS SAJA..!!!
