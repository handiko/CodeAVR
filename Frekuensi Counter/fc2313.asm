...
_0x0:
	...
	.DB  0x69,0x20,0x3A,0x0,0x25,0x64,0x20,0x48
	.DB  0x7A,0x0
_0x2000003:
	.DB  0x80,0xC0
...
_timer1_ovf_isr:
	...
	ST   -Y,R30
; 0000 0026 
; 0000 0027 	TCNT1H=0xC2;
	SBIW R28,32
;	lcd_buff -> Y+0
	RCALL SUBOPT_0x0
; 0000 0028 	TCNT1L=0xF7;
; 0000 0029 
; 0000 002A         frek = hitung;
	LDS  R30,_hitung
	LDS  R31,_hitung+1
	LDS  R22,_hitung+2
	LDS  R23,_hitung+3
...
; 0000 002F         lcd_gotoxy(0,1);
	...
	ST   -Y,R30
	RCALL _lcd_gotoxy
; 0000 0030         sprintf(lcd_buff,"%d Hz",frek);
	MOV  R30,R28
	ST   -Y,R30
	__POINTW1FN _0x0,12
	RCALL SUBOPT_0x2
...
; 0000 003F 	// Clock value: 15.625 kHz
; 0000 0040 	// Mode: Normal top=FFFFh
; 0000 0041 	// OC1A output: Discon.
; 0000 0042 	// OC1B output: Discon.
; 0000 0043 	// Noise Canceler: Off
; 0000 0044 	// Input Capture on Falling Edge
; 0000 0045 	// Timer 1 Overflow Interrupt: On
; 0000 0046 	// Input Capture Interrupt: Off
; 0000 0047 	// Compare A Match Interrupt: Off
; 0000 0048 	// Compare B Match Interrupt: Off
; 0000 0049 	TCCR1A=0x00;
	LDI  R30,LOW(0)
	OUT  0x2F,R30
; 0000 004A 	TCCR1B=0x05;
	LDI  R30,LOW(5)
	OUT  0x2E,R30
; 0000 004B 	TCNT1H=0xC2;
	RCALL SUBOPT_0x0
; 0000 004C 	TCNT1L=0xF7;
...
;
;void main(void)
; 0000 0061 {	init_clock();
_main:
	RCALL _init_clock
; 0000 0062 	init_ports();
	RCALL _init_ports
; 0000 0063 	init_timer();
	RCALL _init_timer
