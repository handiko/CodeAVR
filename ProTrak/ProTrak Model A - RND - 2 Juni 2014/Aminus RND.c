...
void base91_long(void)
{
  	char deg;
        ...
        f_lon = (deg + (min/60.0) + (0.6*sec/36000.0));
        		...
        		if(getchar() == 'G')
        		{
					...
					for(i=0;i<8;i++)
							...
							n_altitude[5] = buff_altitude[i];
                                	...
                                	//for(i=0;i<6;i++)n_altitude[i]-='0';
					altitude=3*(((n_altitude[0]-48)*100000)+((n_altitude[1]-48)*10000)+((n_altitude[2]-48)*1000)
                                		+((n_altitude[3]-48)*100)+((n_altitude[4]-48)*10)+(n_altitude[5]-48));
