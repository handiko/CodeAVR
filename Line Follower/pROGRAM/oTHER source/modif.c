...
if  (depan_kanan!=0){tadi_depan_kanan=10;}
if  (depan_kiri!=0){tadi_depan_kiri=10;}
...
/*------- untuk deteksi sudut 45, siku, sama perempatan ------------*/
    if(front_sensor==0b00000000)
        ...
        if  (tadi_depan_kanan==0&&tadi_depan_kiri>0)     
                {
                rem();backlight=1;
                speed_ki=-speed-100;speed_ka=speed/6;pwm_out();
                for(;;)
                    {
                    delay_us(800);
                    read_sensor();
                ...
                {
                rem();backlight=1;
                speed_ki=speed/6;speed_ka=-speed-100;pwm_out();
                for(;;)
                    {
                    delay_us(800);
                    read_sensor();
