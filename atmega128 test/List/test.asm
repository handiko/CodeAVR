...
; 0000 004A DDRD=0x00;
	...
	OUT  0x11,R30
; 0000 004B 
; 0000 004C // Port E initialization
...
; 0000 004F PORTE=0x00;
	OUT  0x3,R30
; 0000 0050 DDRE=0x00;
	OUT  0x2,R30
; 0000 0051 
; 0000 0052 // Port F initialization
...
; 0000 0055 PORTF=0x00;
	STS  98,R30
; 0000 0056 DDRF=0x00;
	STS  97,R30
; 0000 0057 
; 0000 0058 // Port G initialization
; 0000 0059 // Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 005A // State4=T State3=T State2=T State1=T State0=T
; 0000 005B PORTG=0x00;
	STS  101,R30
; 0000 005C DDRG=0x00;
	STS  100,R30
; 0000 005D 
...
; 0000 00C8 // ADC Clock frequency: 691.200 kHz
; 0000 00C9 // ADC Voltage Reference: AREF pin
; 0000 00CA // Only the 8 most significant bits of
; 0000 00CB // the AD conversion result are used
; 0000 00CC ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 00CD ADCSRA=0x84;
	LDI  R30,LOW(132)
	OUT  0x6,R30
; 0000 00CE 
