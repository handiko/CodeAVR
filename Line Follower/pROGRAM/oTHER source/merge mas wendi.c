...
lcd_clear();
    for(i=0;i<8;i++)
        {
        PORTC=i;
        adc_result1[i]=read_adc(6);
        }

lcd_gotoxy(0,0);sprintf(data,"%d",adc_result1[0]);lcd_puts(data);
lcd_gotoxy(4,0);sprintf(data,"%d",adc_result1[1]);lcd_puts(data);
lcd_gotoxy(8,0);sprintf(data,"%d",adc_result1[2]);lcd_puts(data);
lcd_gotoxy(12,0);sprintf(data,"%d",adc_result1[3]);lcd_puts(data);
lcd_gotoxy(0,1);sprintf(data,"%d",adc_result1[4]);lcd_puts(data);
lcd_gotoxy(4,1);sprintf(data,"%d",adc_result1[5]);lcd_puts(data);
lcd_gotoxy(8,1);sprintf(data,"%d",adc_result1[6]);lcd_puts(data);
lcd_gotoxy(12,1);sprintf(data,"%d",adc_result1[7]);lcd_puts(data);
