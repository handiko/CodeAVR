...
;	i -> R17
;	j -> R18,R19
; 0000 0036 	for(j=0; j<1200; j++)
; 0000 0037     	{	for(i=0; i<16; i++)
; 0000 0038         	{	set_dac(matrix[i]);
; 0000 0039         		delay_us(CONST_1200);
; 0000 003A         	}
; 0000 003B     	}
; 0000 003C         L_BUSY = 0;
; 0000 003D }
...
;	i -> R17
;	j -> R18,R19
; 0000 0043         for(j=0; j<2400; j++)
; 0000 0044         {	for(i=0; i<16; i++)
; 0000 0045         	{	set_dac(matrix[i]);
; 0000 0046                 	delay_us(CONST_2400);
; 0000 0047                 }
; 0000 0048         }
; 0000 0049         L_STBY = 0;
; 0000 004A }
...
;
;void set_dac(char value)
; 0000 0053 {	DAC_0 = value & 0x01;   	// LSB
_set_dac:
;	value -> Y+0
	LD   R30,Y
	ANDI R30,LOW(0x1)
...
_0x1F:
	SBI  0x18,5
_0x20:
; 0000 0056         DAC_3 =( value >> 3 ) & 0x01;	// MSB
	LD   R30,Y
	LSR  R30
	LSR  R30
	LSR  R30
...
_timer0_ovf_isr:
	...
	ADIW R30,1
	MOVW R2,R30
; 0000 006F         if( ((timer%52)==0) || ((timer%28)==0) )
	MOVW R26,R2
	LDI  R30,LOW(52)
	LDI  R31,HIGH(52)
	RCALL __MODW21
...
; 0000 0075                 else
	RJMP _0x28
_0x26:
; 0000 0076         	{  	set_dac(matrix[j]);
	MOV  R30,R4
	RCALL SUBOPT_0x2
; 0000 0077                 	j++;
	INC  R4
; 0000 0078                         if(j==15) j=0;
	LDI  R30,LOW(15)
	CP   R30,R4
	BRNE _0x29
	CLR  R4
...
; 0000 007A         }
; 0000 007B 
; 0000 007C         if(timer==832)	{timer=0; i=0; j=0;}
_0x23:
	LDI  R30,LOW(832)
	LDI  R31,HIGH(832)
	CP   R30,R2
...
; 0000 008E 	TCCR0A=0x00;
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 008F 	TCCR0B=0x01;
	LDI  R30,LOW(1)
	OUT  0x33,R30
; 0000 0090 	TCNT0=0xF5;
	LDI  R30,LOW(245)
	OUT  0x32,R30
...
; 0000 0092 	OCR0B=0x00;
	OUT  0x3C,R30
; 0000 0093 
; 0000 0094 	GIMSK=0x80;
	LDI  R30,LOW(128)
	OUT  0x3B,R30
; 0000 0095 	MCUCR=0x08;
	LDI  R30,LOW(8)
	OUT  0x35,R30
; 0000 0096 	EIFR=0x80;
	LDI  R30,LOW(128)
...
; 0000 009D 	WDTCR=0x38;
	LDI  R30,LOW(56)
	OUT  0x21,R30
; 0000 009E 	WDTCR=0x28;
	LDI  R30,LOW(40)
	OUT  0x21,R30
