...
if((sensor==0b00000001) || (0b11111110)){bkan();      lpwm = 100;       rpwm = 70;      error = 15;     x=1;}  
if((sensor==0b00000011) || (0b11111100)){maju();      lpwm = 90;        rpwm = 70;error = 10;     x=1;}
if((sensor==0b00000010) || (0b11111101)){maju();      lpwm = 80;        rpwm = 70;error = 8;      x=1;}
if((sensor==0b00000110) || (0b11111001)){maju();      lpwm = 70;        rpwm = 70;error = 5;      x=1;}
if((sensor==0b00000100) || (0b11111011)){maju();      lpwm = 70;        rpwm = 70;error = 3;      x=1;}
if((sensor==0b00001100) || (0b11110011)){maju();      lpwm = 70;        rpwm = 70;error = 2;      x=1;}
if((sensor==0b00001000) || (0b11110111)){maju();      lpwm = 70;        rpwm = 70;error = 1;      x=1;}

if((sensor==0b00010000) || (0b11101111)){maju();      rpwm = 70;        lpwm = 70;error = -1;     x=0;}
if((sensor==0b00110000) || (0b11001111)){maju();      rpwm = 70;        lpwm = 70;error = -2;     x=0;}
if((sensor==0b00100000) || (0b11011111)){maju();      rpwm = 70;        lpwm = 70;error = -3;     x=0;}
if((sensor==0b01100000) || (0b10011111)){maju();      rpwm = 70;        lpwm = 70;error = -5;     x=0;}
if((sensor==0b01000000) || (0b10111111)){maju();      rpwm = 80;        lpwm = 70;error = -8;     x=0;}
if((sensor==0b11000000) || (0b00111111)){maju();      rpwm = 90;        lpwm = 70;error = -10;    x=0;}
if((sensor==0b10000000) || (0b01111111)){bkir();      rpwm = 100;error = -15;    x=0;}  

if(sensor==0b11111111)  {maju();        lpwm = 100; rpwm = 100;}
