...
;      35 int i,j;
;      36 
;      37 int receive(int RX_INDEX);
;      38 int send_confirm();
;      39 void try_receive(int INDEX);
;      40 void display(int DISP_INDEX);
;      41 void queue();
;      42 
;      43 void main()
;      44 {       PORTA=0x00;
...
;      74         lcd_clear();
	CALL SUBOPT_0x1
;      75         lcd_gotoxy(0,0);
;      76         lcd_putsf("algorithm selesai");
	__POINTW1FN _0,17
	CALL SUBOPT_0x2
;      77         delay_ms(500);
;      78         lcd_clear();
...
;      90         {       kalimat[RX_INDEX][i]=getchar();
	...
	POP  R27
	ST   X,R30
;      91                 if(kalimat[RX_INDEX][i]=='@')   goto rx_complete;
	CALL SUBOPT_0x4
	LD   R30,Z
	CPI  R30,LOW(0x40)
	BREQ _0x1B
...
;      95 }
;      96 
;      97 void display(int DISP_INDEX)
;      98 {       lcd_clear();
_display:
;	DISP_INDEX -> Y+0
	CALL _lcd_clear
...
_0x21:
	...
	ST   -Y,R30
	CALL _lcd_gotoxy
;     105                 if(kalimat[DISP_INDEX][i]=='@') goto jump;
_0x22:
	CALL SUBOPT_0x4
	LD   R30,Z
	CPI  R30,LOW(0x40)
	BREQ _0x24
;     106                 lcd_putchar(kalimat[DISP_INDEX][i]);
	CALL SUBOPT_0x4
	LD   R30,Z
	ST   -Y,R30
	CALL _lcd_putchar
...
;     115 }
;     116 
;     117 void try_receive(int INDEX)
;     118 {       isPrepared();
_try_receive:
;	INDEX -> Y+0
	CALL _isPrepared
