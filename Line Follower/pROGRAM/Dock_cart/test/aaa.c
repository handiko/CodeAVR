...
eeprom unsigned char e_per4an_dir[10];
...
if (front_sensor==0b00011000||front_sensor==0b00100000||front_sensor==0b00001000||front_sensor==0b00110000||front_sensor==0b00001100)  
{
/*----------percabangan 3 dan 4-----------*/
      if      (rear_sensor==0b00010000||rear_sensor==0b00110000||rear_sensor==0b00100000
                ||rear_sensor==0b00001000||rear_sensor==0b00001100||rear_sensor==0b00000100
                ||rear_sensor==0b00011000||rear_sensor==0b00100100||rear_sensor==0b00111100
