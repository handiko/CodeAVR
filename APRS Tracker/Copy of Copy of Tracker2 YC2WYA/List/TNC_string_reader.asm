...
;
;eeprom char data[300];
;eeprom char mem_status = 0;
;int i;
;
;void transmisi_data(void)
; 0000 00AD {
_transmisi_data:
; 0000 00AE 	/*if(mem_status == 1)
; 0000 00AF         {
; 0000 00B0         	mem_status = 2;
; 0000 00B1                 for(i=0;i<300;i++)
; 0000 00B2                 {
; 0000 00B3                 	data[i] = getchar();
; 0000 00B4                 }
; 0000 00B5         }
; 0000 00B6 
; 0000 00B7 	if(mem_status == 2)
; 0000 00B8         {
; 0000 00B9         	mem_status = 1;
; 0000 00BA                 for(i=0;i<300;i++)
; 0000 00BB                 {
; 0000 00BC                 	putchar(data[i]);
; 0000 00BD                 }
; 0000 00BE         } */
; 0000 00BF 
; 0000 00C0         putchar(getchar());
	RCALL _getchar
	ST   -Y,R30
	RCALL _putchar
; 0000 00C1 }
...
; 0000 00DB // Func7=In Func6=In Func5=In Func4=In Func3=In Func2=In Func1=Out Func0=In
; 0000 00DC // State7=T State6=T State5=T State4=T State3=T State2=T State1=0 State0=P
; 0000 00DD PORTD=0x01;
	LDI  R30,LOW(1)
	OUT  0x12,R30
; 0000 00DE DDRD=0x02;
	LDI  R30,LOW(2)
...
; 0000 011A UCSRA=0x00;
	OUT  0xB,R30
; 0000 011B UCSRB=0xD8;
	LDI  R30,LOW(216)
	OUT  0xA,R30
; 0000 011C UCSRC=0x86;
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 011D UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 011E UBRRL=0x47;
	LDI  R30,LOW(71)
	OUT  0x9,R30
; 0000 011F 
...
; 0000 0123 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x8,R30
; 0000 0124 SFIOR=0x00;
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 0125 
; 0000 0126 // ADC initialization
; 0000 0127 // ADC disabled
; 0000 0128 ADCSRA=0x00;
	OUT  0x6,R30
; 0000 0129 
; 0000 012A // SPI initialization
; 0000 012B // SPI disabled
; 0000 012C SPCR=0x00;
	OUT  0xD,R30
; 0000 012D 
; 0000 012E // TWI initialization
; 0000 012F // TWI disabled
; 0000 0130 TWCR=0x00;
	OUT  0x36,R30
; 0000 0131 
; 0000 0132 // Global enable interrupts
; 0000 0133 #asm("sei")
	sei
; 0000 0134 
; 0000 0135 PORTC.0 = 0;
...
; 0000 0137 
; 0000 0138 /*
; 0000 0139 if(mem_status==0)
; 0000 013A {
; 0000 013B 	for(i=0;i<300;i++)
; 0000 013C         {
; 0000 013D         	data[i] = 0;
; 0000 013E         }
; 0000 013F }
; 0000 0140 
; 0000 0141 mem_status = 1; */
; 0000 0142 
; 0000 0143 while (1)
_0x18:
; 0000 0144       {
; 0000 0145       // Place your code here
; 0000 0146       		transmisi_data();
	RCALL _transmisi_data
; 0000 0147 
; 0000 0148       }
	RJMP _0x18
; 0000 0149 }
