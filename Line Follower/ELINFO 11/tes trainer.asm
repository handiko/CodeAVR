...
__DELAY_USW_LOOP:
	...
	.INCLUDE "tes trainer.vec"
	.INCLUDE "tes trainer.inc"
...
;      34 #define         t7      PIND.7
;      35 
;      36 #define         l0      PORTC.0
;      37 #define         l1      PORTC.1
;      38 #define         l2      PORTC.2
;      39 #define         l3      PORTC.3
;      40 #define         l4      PORTC.4
;      41 #define         l5      PORTC.5
;      42 #define         l6      PORTC.6
;      43 #define         l7      PORTC.7
;      44 
;      45 #define         on      1
;      46 #define         off     0
;      47 #define         ON      1
